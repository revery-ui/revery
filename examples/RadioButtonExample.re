...
module RadioExample = {
  ...
  let make = () => {
    component(slots => {
      let (radioVal, setRadioVal, _slots: React.Hooks.empty) = React.Hooks.state("Select a button!", slots);
      <View
        style=Style.[
        width(500),
        height(500),
        ...
        <Text 
          text=radioVal
          style=Style.[fontSize(20), fontFamily("Roboto-Regular.ttf"), marginTop(20)]/>
      </View>
    })
  }
