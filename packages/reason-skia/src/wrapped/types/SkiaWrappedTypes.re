...
module M = (T: TYPE) => {
  ...
  module ImageFilter = {
    ...
    module DropShadow = {
      ...
      let shadowMode: T.typ(shadowMode) =
        skiaCEnum(
  ...
  let pixelGeometry: T.typ(pixelGeometry) =
    skiaCEnum(
      "sk_pixelgeometry_t",
      [
  ...
  module Gr = {
    ...
    let surfaceOrigin: T.typ(surfaceOrigin) =
      skiaCEnum(
        "gr_surfaceorigin_t",
        [
